...
export function useMotion() {
  useEffect(() => {
    ...
    const fxTweens = [
      ...
      ...play(".fx-areas .reveal", { y: 36 }, { stagger: 0.16, trigger: document.querySelector(".fx-areas") }),
      ...
      ...play(".fx-diffs .reveal", { y: 32 }, { stagger: 0.11, trigger: document.querySelector(".fx-diffs") }),
    ...
    const parallax = gsap.utils.toArray(".photo-stage-dark img").map((img) => {
